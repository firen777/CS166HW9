...
public class Test
{
  ...
  public static void main2(String[] paramArrayOfString)
  {
    ...
    Object localObject = new CaliBlocker (new LSATDecorator(new GraduateDecorator(new ForeignDecorator(new GPAEvaluator())))); //delegation chain
    ...
    localObject = new CaliBlocker (new MCATDecorator(new GraduateDecorator(new ForeignDecorator(new GPAEvaluator()))));
    checkAccept(localD, (Evaluator)localObject);
